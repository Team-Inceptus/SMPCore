...
public class Mute implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		sender.sendMessage(ChatColor.GREEN + "Successfully muted " + ChatColor.GOLD + target.getName());
		if (target.isOnline()) target.getPlayer().sendMessage(ChatColor.RED + "You have been muted by " + sender.getName() + "!");
